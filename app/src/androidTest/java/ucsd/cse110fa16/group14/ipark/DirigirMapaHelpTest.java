...
public class DirigirMapaHelpTest {
    // ** if test does not pass when you run it, try running it again. Gradle is being hard to work with **
    private FirebaseAuth auth = FirebaseAuth.getInstance();

    @Rule
    public ActivityTestRule<DirigirMapa> mActivityRule = new ActivityTestRule<>(
            DirigirMapa.class);
    ...
    public void clickingHome() throws InterruptedException {
        ...
        // click on the help button to see information on the page
