...
public class LoginPage extends AppCompatActivity {
    ...
    private void signIn() {
        ...
        if (TextUtils.isEmpty(username) || TextUtils.isEmpty(password)) {
            Toast.makeText(LoginPage.this, "Por favor, introduzca su nombre de usuario y constraseña",
                    Toast.LENGTH_LONG).show();
        } else {
            if (!(DriverRegistration.uMapEmail.containsKey(username))) {
                Toast.makeText(LoginPage.this, "Nombre de usuario no válido", Toast.LENGTH_LONG).show();
                ...
                auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            progress.dismiss();
                            Toast.makeText(LoginPage.this, "Contraseña Inválida.\nInténtalo de nuevo.",
                                    Toast.LENGTH_LONG).show();
                            passwordField.setText("");
                        } else {
                            Toast.makeText(LoginPage.this, "Inicio de Sesión exitosamente",
                                    Toast.LENGTH_LONG).show();
                            Intent intent;
