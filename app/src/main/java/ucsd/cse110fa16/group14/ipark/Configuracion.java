...
public class Configuracion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currP.setText(String.format("S/%.2f", priceVal));
        ...
        change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (n.equals("")) {
                    Toast.makeText(Configuracion.this, "Por favor ingrese un precio válido", Toast.LENGTH_LONG).show();
                } else {
                    final double newPrice = Double.parseDouble(n);
                    iLink.changePrice(newPrice);
                    iLink.defaultPrice = newPrice;

                    AlertDialog.Builder updated = new AlertDialog.Builder(Configuracion.this);
                    updated.setTitle("Información de Ayuda");
                    updated.setMessage("El precio actual es : S/" + newPrice);
                    ...
                    updated.setNegativeButton("Confirm", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            currP.setText(String.format("S/%.2f", newPrice));
                            newP.setText("");
                            dialog.cancel();
                        }
                    });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Configuracion.this, PaginaInicio.class);
