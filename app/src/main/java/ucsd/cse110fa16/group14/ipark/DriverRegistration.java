...
public class DriverRegistration extends AppCompatActivity {
    ...
    protected void getData() {
        ...
        userReference.addValueEventListener(new com.firebase.client.ValueEventListener() {
            ...
            public void onCancelled(FirebaseError firebaseError) {
                Toast.makeText(DriverRegistration.this, "No se pudo conectar a la base de datos", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void createAccount(String mail, String pass) {
        ...
        if (TextUtils.isEmpty(mail) || TextUtils.isEmpty(pass)) {
            Toast.makeText(DriverRegistration.this, "Por favor ingrese usuario y contraseña.", Toast.LENGTH_LONG).show();
        } else {
            progress.show();
            ...
            auth.createUserWithEmailAndPassword(mail, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (!task.isSuccessful()) {
                        progress.dismiss();
                        Toast.makeText(DriverRegistration.this, "Error al registrarse", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(DriverRegistration.this, "Registrarse exitosamente", Toast.LENGTH_LONG).show();
