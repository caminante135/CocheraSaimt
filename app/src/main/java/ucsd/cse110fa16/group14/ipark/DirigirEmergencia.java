 ...
 */
public class DirigirEmergencia extends AppCompatActivity {
    ...
    // inner class used to retrieve data from Firebase for display in the Emergencia layout
    class commentBoss {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dirigir_emergencia);
