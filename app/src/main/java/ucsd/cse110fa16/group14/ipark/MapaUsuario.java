...
public class MapaUsuario extends View {
    ...
    public MapaUsuario(Context context) {
        super(context);
        init(context);
    }

    public MapaUsuario(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MapaUsuario(Context context, AttributeSet attrs, int defStyle) {
