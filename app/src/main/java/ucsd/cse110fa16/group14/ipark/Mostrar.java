...
/**
 *  Used for the emergency mostrar window in Owner Homepage
...
public class Mostrar extends Activity {
    ...
    private ArrayList<Mostrar.emergency> list = new ArrayList<>();
    private Mostrar.emergency temp;
    ...
    protected void onCreate(Bundle savedInstance) {
        ...
        int width = dm.widthPixels;    // width of mostrar window
        int height = dm.heightPixels;  // height of mostrar window

        getWindow().setLayout((int)(width*.8),(int)(height*.3));  // size of mostrar window

        listView = (ListView) findViewById(R.id.listViewWindow);
        root = new Firebase("https://ipark-e243b.firebaseio.com/NewEmergency");
        final ArrayAdapter<Mostrar.emergency> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, list);
