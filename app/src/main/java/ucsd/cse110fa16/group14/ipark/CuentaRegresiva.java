 ...
 */
public class CuentaRegresiva extends AppCompatActivity {
    private Firebase root;
    private ListView listView;
    private ArrayList<commentObj> list = new ArrayList<>();
    private commentObj temp;

    // inner class used to retrieve data from Firebase to display in the CuentaRegresiva layout
    class commentObj {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dirigir_comentario);
