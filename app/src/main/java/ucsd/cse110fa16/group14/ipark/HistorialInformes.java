 ...
 */
public class HistorialInformes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_historial_informe);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HistorialInformes.this, PaginaUsuario.class);
        ...
        prevButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HistorialInformes.this, HistorialReservas.class);
                startActivity(intent);
            }
        });
    }
