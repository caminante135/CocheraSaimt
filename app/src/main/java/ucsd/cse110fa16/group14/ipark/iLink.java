    ...
    public static void checkout(final String spot, final long startTime) {
        ...
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            ...
            public void onCancelled(FirebaseError firebaseError) {
                Log.v("Sin error de acceso", "No se pudo conectar a Firebase");
            }
        });
    ...
    public static void setOrder(final String spot, final long startTime, final long endTime) {
        ...
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                ...
                System.out.println("=================================");
                System.out.println("Asignando un nuevo lugar de estacionamiento");
                System.out.println("=================================");
                System.out.println("  Horario Actual:  " + schedule);
                System.out.println("  Sitio Asignado:     " + spot);
                //System.out.println("  User Registering:  " + userName);
                System.out.println("  Hora de inicio en seg: " + startTime);
                System.out.println("  Hora de finalización en seg: " + endTime);
                ...
                System.out.println("  Nuevo horario:      " + newSchedule);
                if (newSchedule != null) scheduleRef.setValue(newSchedule);
            }
        ...
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                ...
                while (userIter.hasNext()) {
                    ...
                    System.out.println("Alerta "+username);
    ...
    private static void updateUserReservationStatus(final String userName, String spot, long startTime, long endTime) {
        ...
        parkingLotLink.addListenerForSingleValueEvent(new com.firebase.client.ValueEventListener() {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                ...
                System.out.println("Tarifa: " + parkingLotRate);
            }
