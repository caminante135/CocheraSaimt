...
public class MensajesUsuariosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mensajes_usuarios);
        ...
        msgCancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MensajesUsuariosActivity.this, PaginaInicio.class);
