...
public class RegistroConductor extends AppCompatActivity {
        ...
        */
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RegistroConductor.this, InicioSesion.class);
        ...
        help.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder hlp = new AlertDialog.Builder(RegistroConductor.this);
                hlp.setTitle("Información de Ayuda");
                hlp.setMessage("\t\t\t\tToda la información proporcionada se mantendra confidencial.\n" +
                        "\t\t\t\tPor favor ingrese un email válido y una licencia de conducir.\n" +
                        "\t\t\t\tUna contraseña válida será al menos de longitud seis.\n" +
                        "\t\t\t\tPor favor click \"No soy un robot\" antes de enviar.");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userExists && emailExists) {
                    String msg = "Se toman tanto el nombre de usuario como el e-mail. Intentalo de nuevo.";
    ...
    protected void getData() {
        ...
        userReference.addValueEventListener(new com.firebase.client.ValueEventListener() {
            ...
            public void onCancelled(FirebaseError firebaseError) {
                Toast.makeText(RegistroConductor.this, "No se pudo conectar a la base de datos", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void createAccount(String mail, String pass) {
        ...
        if (TextUtils.isEmpty(mail) || TextUtils.isEmpty(pass)) {
            Toast.makeText(RegistroConductor.this, "Por favor ingrese usuario y contraseña.", Toast.LENGTH_LONG).show();
        } else {
            progress.show();
            ...
            auth.createUserWithEmailAndPassword(mail, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (!task.isSuccessful()) {
                        progress.dismiss();
                        Toast.makeText(RegistroConductor.this, "Error al registrarse", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(RegistroConductor.this, "Registrarse exitosamente", Toast.LENGTH_LONG).show();
                        ...
                        auth.getCurrentUser().updateProfile(displayName).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (!task.isSuccessful()) {
                                    Toast.makeText(RegistroConductor.this,
                                            "No se pudo establecer el nombre para mostrar", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
